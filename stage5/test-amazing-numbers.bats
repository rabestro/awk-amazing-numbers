...
@test 'Nine is a spy number' {
  run gawk -f amazing-numbers.awk <<< 9
  assert_success
  assert_output --partial 'Properties of 9'
  assert_output --partial 'even: false'
  assert_output --partial 'odd: true'
  assert_output --partial 'buzz: false'
  assert_output --partial 'duck: false'
  assert_output --partial 'spy: true'
  assert_output --partial 'palindromic: true'
  assert_output --partial 'gapful: false'
}

@test 'Ten is not a spy number' {
  run gawk -f amazing-numbers.awk <<< 10
  assert_success
  assert_output --partial 'Properties of 10'
  assert_output --partial 'even: true'
  assert_output --partial 'odd: false'
  assert_output --partial 'buzz: false'
  assert_output --partial 'duck: true'
  assert_output --partial 'spy: false'
  assert_output --partial 'palindromic: false'
  assert_output --partial 'gapful: false'
}
